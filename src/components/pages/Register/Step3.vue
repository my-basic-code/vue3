<template>
  <article>
    <Input label="이메일" type="email" name="email" placeholder="이메일을 입력해주세요" classLabel="block text-base font-bold"
    ...
    <Input type="password" name="repeatPassword" placeholder="비밀번호를 재 입력해주세요" wrapClass="mt-3"
      classLabel="block text-base font-bold" :className="`px-5 py-4 mt-[6px] w-full ${classInputCustom[2].input}`"
